...
| band and composer never share a pixel | PASS | mid-reply, both windows visible: band {"x":2047,"y":1144,"width":125,"height":102,"scaleFactor":1.5}, composer {"x":1858,"y":1082,"width":360,"height":50,"scaleFactor":1.5}, pet.y 588. The band steps below the composer (contracts 5.3 step 6 / 6.1), so app-desktop.png carries both. |
